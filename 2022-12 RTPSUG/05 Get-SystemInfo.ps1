Function Get-SystemInfo{
    ...
    if($IsLinux){
        ...
        # Run the stat command and parse the output for the Birth line, then extract the date
        ...
        # Orginal Windows system information commands
...
# Convert results to JSON to allow the output to be parsed
